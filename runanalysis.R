...
file.choose()
# read activity names
activitynames <- read.csv("/Users/eshanchatty/Downloads/UCI HAR Dataset/activity_labels.txt", sep="", 
                          header=FALSE, col.names=c("label", "activity"))

# read and clean feature names
features <- read.table("/Users/eshanchatty/Downloads/UCI HAR Dataset/features.txt", stringsAsFactors = FALSE)[,2]
# remove parentheses
...
subjtest <- read.csv("/Users/eshanchatty/Downloads/UCI HAR Dataset/test/subject_test.txt", header=FALSE
                     , colClasses = "factor", col.names="subject")
subjtrain <- read.csv("/Users/eshanchatty/Downloads/UCI HAR Dataset/train/subject_train.txt", header=FALSE
                      , colClasses = "factor", col.names="subject")
xtestsrc <- read.csv("/Users/eshanchatty/Downloads/UCI HAR Dataset/test/X_test.txt", sep="", 
                     header=FALSE, col.names=featurenames)
ytestsrc <- read.csv("/Users/eshanchatty/Downloads/UCI HAR Dataset/test/y_test.txt", header=FALSE, col.names="label")
xtrainsrc <- read.csv("/Users/eshanchatty/Downloads/UCI HAR Dataset/train/X_train.txt", sep="", header=FALSE,
                      col.names=featurenames)
ytrainsrc <- read.csv("/Users/eshanchatty/Downloads/UCI HAR Dataset/train/y_train.txt", header=FALSE, col.names="label")
...
write.table(resultset, file="/Users/eshanchatty/Downloads/result.txt", sep="\t", row.name=FALSE)
